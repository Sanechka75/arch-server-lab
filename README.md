...
arch-server-lab/
├── server_health_check.sh   # Основной скрипт
└── README.md
Автор
...
| Было | Стало |
|------|-------|
| Простой текст | Бейджики (значки) в начале |
| Устаревший путь в cron | Актуальный путь (`~/MyFiles/...`) |
| Вложенные бэктики | Чистые блоки кода |
| Нет структуры технологий | Таблица технологий |
